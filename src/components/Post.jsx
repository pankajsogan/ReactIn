...
function Post() {
  ...
  <path d="M14 12a2 2 0 11-2-2 2 2 0 012 2zM4 10a2 2 0 102 2 2 2 0 00-2-2zm16 0a2 2 0 102 2 2 2 0 00-2-2z"></path>
         ...
         <div className="post__body__header">
            <div className="post__body__header__avatar"></div>
            <div className="post__top__header__info">
               ...
               <span className="post__timestamp"><span>1d</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" class="mercado-match" width="16" height="16" focusable="false">
